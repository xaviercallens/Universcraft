pub fn get_advanced_scene_wgsl(scene_id: &str) -> String {
    if scene_id == "ocean_sunset" {
        return include_str!("../../assets/shaders/scene_ocean_sunset.wgsl").to_string();
    }

    if scene_id == "desert_dunes" {
        return include_str!("../../assets/shaders/scene_desert_dunes.wgsl").to_string();
    }

    if scene_id == "ice_glacier" {
        return include_str!("../../assets/shaders/scene_ice_glacier.wgsl").to_string();
    }

    if scene_id == "black_hole" {
        return include_str!("../../assets/shaders/scene_black_hole.wgsl").to_string();
    }

    if scene_id == "earth_orbit" {
        return include_str!("../../assets/shaders/scene_earth_orbit.wgsl").to_string();
    }

    if scene_id == "cloudscape" {
        return include_str!("../../assets/shaders/scene_cloudscape.wgsl").to_string();
    }
